 ...
 * workflow templates, expense categories. Safe to run on every deploy.
 * Users are NOT seeded here — the admin account is created by
 * `pnpm --filter @mams/api seed:admin` (it needs better-auth's password hasher).
 */
import { eq } from "drizzle-orm";
import { createDb } from "./index";
import { expenseCategories, skills, stages, stageSkills, templateStages, workflowTemplates } from "./schema/index";
